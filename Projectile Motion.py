...
g = float(input("What gravitational constant do you want to use? Earth's gravity is ~9.8 m/s^2. Numbers equal or less than zero cannot be used.\n"))  # Gravity
vo = float(input("What is the original x velocity? must be greater than 0.\n"))  # Original Velocity
theta_deg = float(input("What angle is it being launched in degrees? Max 90, min >0.\n"))  # Degrees from horizontal to aim the "cannon"
